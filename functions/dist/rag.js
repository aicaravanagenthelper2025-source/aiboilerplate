function mockSearch(kind, query, k) {
...
export async function retrieveHybrid(query, kInternal = 3, kWeb = 3) {
    ...
    if (strongInternal.length >= 3)
        return strongInternal.slice(0, 3);
